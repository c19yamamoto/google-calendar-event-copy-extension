...
- **左クリック**: イベント URL をクリップボードにコピー
- **右クリック**: 「タイトルも含めてコピーする」オプションを切り替え

ボタンにマウスを乗せると、現在のオプション設定が表示されます。

## オプション

下記の方法でオプションを設定できます:

1. **コピーボタンを右クリック** (推奨): イベントモーダルのコピーボタンを右クリックすることで、その場でオプションを切り替えられます
2. **オプションページから**: 拡張機能のコロン (`:`) をクリックして「オプション」を押下するとオプションページが表示されます
